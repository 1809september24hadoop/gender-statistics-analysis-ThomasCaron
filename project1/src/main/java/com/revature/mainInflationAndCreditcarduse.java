 ...
 */
public class mainInflationAndCreditcarduse {

	public static void main(String[] args) throws Exception {

		/**
		 * hadoop jar /home/cloudera/mrjars/WordCountonSampleData.jar com.revature.WordCount  HData/sampledata HData/WordCountonsampledata
		...
		if (args.length != 2) {
			System.out.printf(
					"Usage: mainAvgFemaleEduInUSA <input dir> <output dir>\n");
			System.exit(-1);
		}
		 ...
		 */
		job.setJarByClass(mainInflationAndCreditcarduse.class);

		/*
		 * Specify an easily-decipherable name for the job.
		 * This job name will appear in reports and logs.
		 */
		job.setJobName("main Inflation And Creditcard use");
		...
		job.setMapperClass(inflationAndCreditcarduseMapper.class);



		job.setReducerClass(inflationAndCreditcarduseReducer.class);
