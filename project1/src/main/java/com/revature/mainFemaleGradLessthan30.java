 ...
 */
public class mainFemaleGradLessthan30 {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		job.setJarByClass(mainFemaleGradLessthan30.class);

		/*
		 * Specify an easily-decipherable name for the job.
		 * This job name will appear in reports and logs.
		 */
		job.setJobName("female grad less than 30");
		 ...
		 */
		job.setMapperClass(countriesFemaleGradLessThan30Mapper.class);



		job.setReducerClass(femaleGradLessThan30Reducer.class);
		 ...
		 */
		job.setOutputKeyClass(Text/*ArrayWritable*/.class);
