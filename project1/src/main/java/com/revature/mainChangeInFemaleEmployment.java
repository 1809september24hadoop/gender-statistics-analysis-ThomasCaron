...
public class mainChangeInFemaleEmployment {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		job.setJarByClass(mainChangeInFemaleEmployment.class);

		/*
		 * Specify an easily-decipherable name for the job.
		 * This job name will appear in reports and logs.
		 */
		job.setJobName("change In Female Employment");
		 ...
		 */
		job.setMapperClass(changeInFemaleEmployment.class);
