 ...
 */
public class mainAvgFemaleEduInUSA {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		job.setJarByClass(mainAvgFemaleEduInUSA.class);

		/*
		 * Specify an easily-decipherable name for the job.
		 * This job name will appear in reports and logs.
		 */
		job.setJobName("Avg Female Edu In USA");
		...
		job.setMapperClass(avgIncreaseInFemaleEducationMapper.class);


		job.setReducerClass(avgIncreaseInFemaleEducationReducer.class);	
