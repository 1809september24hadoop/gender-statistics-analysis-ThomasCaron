 ...
 */
public class mainChangeInMaleEmployment {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		job.setJarByClass(mainChangeInMaleEmployment.class);

		/*
		 * Specify an easily-decipherable name for the job.
		 * This job name will appear in reports and logs.
		 */
		job.setJobName("main Change In Male Employment");
		 ...
		 */
		job.setMapperClass(changeInMaleEmployment.class);
