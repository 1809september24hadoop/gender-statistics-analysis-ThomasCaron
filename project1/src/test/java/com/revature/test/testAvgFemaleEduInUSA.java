...
import com.revature.map.avgIncreaseInFemaleEducationMapper;
import com.revature.reduce.avgIncreaseInFemaleEducationReducer;
import com.revature.reduce.inflationAndCreditcarduseReducer;

public class testAvgFemaleEduInUSA {
	...
	static String lineIn = "\"United States\",\"USA\",\"Educational attainment, at least Bachelor's or equivalent, population 25+, female (%) (cumulative)\",\"SE.TER.CUAT.BA.FE.ZS\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"31.39076\",\"32.00147\",\"32.67396\",\"\",";
	static Text mapOut =new Text( "United States#USA#Educational attainment, at least Bachelor's or equivalent, population 25+, female (%) (cumulative)#SE.TER.CUAT.BA.FE.ZS######################################################31.39076#32.00147#32.67396#");
	static Text reduceOut = new Text("United States   Average Increase in: Educational attainment, at least Bachelor's or equivalent, population 25+, female (%) (cumulative):  ");
...
//		String lineOut = "Arab World#ARB#Credit card used in the past year, female (% age 15+) [w2]#WP14892.3#########################################################";
		 ...
		 */
		avgIncreaseInFemaleEducationMapper mapper = new avgIncreaseInFemaleEducationMapper();
		 ...
		 */
		avgIncreaseInFemaleEducationReducer reducer = new avgIncreaseInFemaleEducationReducer();
...
//				+"\n";
		...
		reduceDriver.withOutput(reduceOut, new DoubleWritable(31.696115));//new Text("cat"), new IntWritable(2));
...
//				 */
				mapReduceDriver.addOutput(reduceOut, new DoubleWritable(31.696115));
//		
//				/*
//				 * Run the test.
//				 */
